...
assert_contains "$SELECTOR" 'echo "21\) Selector Guide"' "Menu option 21 must exist"
...
assert_contains "$SELECTOR" '8\) show_status ;;' "Menu option 8 must be wired"
assert_contains "$SELECTOR" '9\) backup_runtime_config ;;' "Menu option 9 must be wired"
assert_contains "$SELECTOR" '10\) reset_markers ;;' "Menu option 10 must be wired"
assert_contains "$SELECTOR" '11\) print_effective_config ;;' "Menu option 11 must be wired"
...
assert_contains "$SELECTOR" '21\) run_sector "\$SECTOR_DIR/92-selector-guide.sh" ;;' "Menu option 21 must be wired"
